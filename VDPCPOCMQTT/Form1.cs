    ...
    public partial class Form1 : Form
    {
        ...
        private async void ButtonPublisherStartClick(object sender, EventArgs e)
        {
            ...
            var options = new MqttClientOptions
            {
                ...
                {
                    Server = this.TextBoxURI.Text.Trim(), Port = int.Parse(this.TextBoxPort.Text.Trim()), TlsOptions = tlsOptions
                }
            };
            ...
            */
            ...
            this.managedMqttClientPublisher.DisconnectedHandler = new MqttClientDisconnectedHandlerDelegate((Action<MqttClientDisconnectedEventArgs>)OnPublisherDisconnected);
        ...
        */
        ...
        private async void ButtonSubscriberStartClick(object sender, EventArgs e)
        {
            ...
            var options = new MqttClientOptions
            {
                ...
                ChannelOptions = new MqttClientTcpOptions
                {
                    Server = TextBoxURI.Text.Trim(), Port = int.Parse(this.TextBoxPort.Text.Trim()), TlsOptions = tlsOptions
                }
            };
            ...
            */
            ...
            Form1 form1 = this;
            this.managedMqttClientSubscriber.ConnectedHandler = new MqttClientConnectedHandlerDelegate((Action<MqttClientConnectedEventArgs>) OnSubscriberConnected);
            this.managedMqttClientSubscriber.DisconnectedHandler = new MqttClientDisconnectedHandlerDelegate((Action<MqttClientDisconnectedEventArgs>) OnSubscriberDisconnected);
            this.managedMqttClientSubscriber.ApplicationMessageReceivedHandler = new MqttApplicationMessageReceivedHandlerDelegate((Action<MqttApplicationMessageReceivedEventArgs>)this.OnSubscriberMessageReceived);
